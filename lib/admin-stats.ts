...
export async function getAdminStats() {
  ...
  const [
    totalUsers, customerCount, landlordCount, adminCount,
    totalListings, activeListings, roomCount, equipmentCount, spaceCount,
    totalBookings, pendingBookings, confirmedBookings, inProgressBookings,
    completedBookings, cancelledBookings,
    revenueData, thisMonthRevenue, lastMonthRevenue, recentBookings,
  ] = await Promise.all([
    prisma.user.count(),
  ...
  return {
    users: { total: totalUsers, customers: customerCount, landlords: landlordCount, admins: adminCount },
    listings: { total: totalListings, active: activeListings, rooms: roomCount, equipment: equipmentCount, spaces: spaceCount },
    bookings: {
