    ...
    <>
      ...
      <main className="min-h-screen bg-gradient-to-br from-slate-900 via-blue-900 to-slate-900 pt-20">
        ...
        <div className="relative max-w-7xl mx-auto px-4 py-12">
          {/* Filter Section */}
          <Card className="mb-8 backdrop-blur-md bg-white/10 border border-white/20 p-6">
            <h2 className="text-white text-xl font-semibold mb-6">Filter Listings</h2>
          ...
          {isLoading ? (
            ...
            <>
              <div className="mb-6">
                <p className="text-white/70">
                  Found <span className="text-white font-semibold">{pagination?.total}</span> listings
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
                {listings.map((listing) => (
                  <Link key={listing.id} href={`/listings/${listing.id}`}>
                    <Card className="h-full backdrop-blur-md bg-white/10 border border-white/20 overflow-hidden hover:border-white/40 transition-all cursor-pointer group">
                      ...
                      <div className="p-4 space-y-3">
                        ...
                        <div className="flex items-center justify-between">
                          <p className="text-white font-semibold">${listing.pricePerDay}/day</p>
            ...
            <div className="text-center py-12">
              <p className="text-white/70">No listings found. Try adjusting your filters.</p>
            </div>
          )}
        </div>
      </main>
